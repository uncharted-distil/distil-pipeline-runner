...
RUN pip3 install -e git+ssh://git@github.com/unchartedsoftware/distil-fuzzy-join.git@afd3a019ea8e2a7047cf4df919b833b6b27e7b77#egg=DistilFuzzyJoin --process-dependency-links
