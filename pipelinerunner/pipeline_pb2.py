...
_PIPELINEDESCRIPTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='digest', full_name='PipelineDescription.digest', index=10,
...
_PIPELINEDESCRIPTION.fields_by_name['context'].has_options = True
_PIPELINEDESCRIPTION.fields_by_name['context']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
